...
def form_to_fill(drive):
    ...
    for i in range(1,50):
        try:
            drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div/div/div[2]/div[2]/div/ul/li['+str(i)+']/div[2]')
            res += 1
...
def chk_len_opt(pathvar,driver):
    ...
    for j in range(1,15):
        try:
            driver.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[2]/div[2]/form/div/div/div['+str(pathvar)+']/div[2]/div/div/table/tbody/tr['+str(j)+']/td[3]/label/span')
            res+=1
        except NoSuchElementException:
            break
    return res
def work(ida,passa,chrD_path,pref_sel):
    ...
    drive.find_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/form/div[1]/input[1]').send_keys(ida) # id (Check auth file)
    drive.find_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/form/div[2]/input').send_keys(passa) # password (Check auth file)
    drive.find_element(By.XPATH,'/html/body/div[1]/div/div/div[2]/form/div[4]/button').click()
    drive.implicitly_wait(5)#resolver_err_site_ele('/html/body/div[3]/div/div[2]/div[2]/div/div/div[1]/button', drive)
    try:
        drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[3]/div/div/div[1]/button').click()
    except:
        pass
    
    try:
        drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[4]/div/div/div[1]/button').click()
    except:
        pass
    try:
        drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[2]/div/div/div[1]/button').click()
    except:
        pass
    try: 
        drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[1]/div/div/div[1]/button').click()
    except:
        pass

    drive.find_element(By.XPATH,'/html/body/div[3]/div/div[1]/div[1]/div[1]/ul/li[6]/a/span').click()
    ...
    for i in range(1,form_to_fill(drive)+1): ## Number of feedback forms you have to fill
        ...
        if cond == 0:
            ...
            for j in range(1,chk_len_opt(1,drive)+1):
                ...
                drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[2]/div[2]/form/div/div/div[1]/div[2]/div/div/table/tbody/tr['+str(j)+']/td['+str(pref_sel+2)+']/label/span').click()
                                    
                #drive.execute_script("window.scrollTo(0,0)")
            for k in range(1,chk_len_opt(2,drive)+1):
                if temp_pref_sel == 6:
                    pref_sel = random.randint(1, 3)
                drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[2]/div[2]/form/div/div/div[2]/div[2]/div/div/table/tbody/tr['+str(k)+']/td['+str(pref_sel+2)+']/label/span').click()
            for l in range(1,chk_len_opt(3,drive)+1):
                if temp_pref_sel == 6:
                    pref_sel = random.randint(1, 3)
                drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[2]/div[2]/form/div/div/div[3]/div[2]/div/div/table/tbody/tr['+str(l)+']/td['+str(pref_sel+2)+']/label/span').click()
            for o in range(1,chk_len_opt(4,drive)+1):
                if temp_pref_sel == 6:
                    pref_sel = random.randint(1, 3)
                drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[2]/div[2]/form/div/div/div[4]/div[2]/div/div/table/tbody/tr['+str(o)+']/td['+str(pref_sel+2)+']/label/span').click()
            for m in range(1,chk_len_opt(5,drive)+1):
                if temp_pref_sel == 6:
                    pref_sel = random.randint(1, 3)
                drive.find_element(By.XPATH,'/html/body/div[3]/div/div[2]/div[2]/div[2]/form/div/div/div[5]/div[2]/div/div/table/tbody/tr['+str(m)+']/td['+str(pref_sel+2)+']/label/span').click()
            for n in range(1,4):
